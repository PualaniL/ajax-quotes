<html>
  ...
  <body>
    ...
    <p> Our application fetches random quotes from a server using AJAX requests. <br>
      <br>
        Quotes fades in and out every 5 seconds and iterates through three different fonts we imported.             
    </p>
      ...
      function getRandomQuote()
        {
          ...
          xhr.onerror = function(){
            alert("Uh Oh! We received an XHR error :(");
          };
